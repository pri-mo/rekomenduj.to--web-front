  ...
  <div class="page__wrapper">
    ...
    <main>
      ...
      <section class="layout--base content--small-type">
        ...
        <ol>
          <li>Regulamin niniejszy reguluje zasady korzystania z aplikacji Rekomenduj.to</li>
          <li>Definicje pojęć użytych w Regulaminie:
            <ol><li><strong>Rekomenduj.to</strong> oznacza aplikację internetową prowadzony przez Buzz Media udostępnioną pod adresem www.rekomenduj.to oraz w marketach aplikacji na iOS i Android</li>
              ...
              <li><strong>Użytkownik</strong> – oznacza każdą osobę fizyczną, która zarejestrowała się w aplikacji Rekomenduj.to </li>
              <li><strong>Konto</strong> – prowadzone dla Użytkownika przez Buzz Media konto, będące zbiorem zasobów, w którym gromadzone są Dane Użytkownika oraz informacje o jego działaniach w ramach aplikacji Rekomenduj.to</li>
              <li><strong>Dane</strong> – dane osobowe Użytkownika oraz inne dane i treści zamieszczane przez Użytkownika w aplikacji Rekomenduj.to</li>
        ...
        <h2>II. Zasady rejestracji i uczestnictwa w aplikacji Rekomenduj.to</h2>
        <ol>
        <li>Użytkownikiem aplikacji Rekomenduj.to może zostać:
            <ol>
              ...
              <li>Użytkownikiem aplikacji Rekomenduj.to jest każda osoba, która spełnia wymagania określone w ustępie powyższym i założyła Konto w aplikacji Rekomenduj.to.</li>
              <li>Założenie Konta obejmuje następujące czynności:</li>
              ...
              <li>wyrażenie zgody na przetwarzanie danych osobowych Użytkownika przez Buzz Media w brzmieniu wskazanym przez Buzz Media, przy czym zgoda wyrażona przez niepełnoletniego wymaga zgody rodziców lub opiekunów prawnych</li>
              <li>akceptację niniejszego Regulaminu oraz Polityki Prywatności</li>
            </ol>
          </li>
          <li>Założenie Konta oraz korzystanie z aplikacji Rekomenduj.to jest dobrowolne i bezpłatne.</li>
          <li>Zakreślenie odpowiedniego pola obok formułki „Zapoznałem się i akceptuję warunki i zasady Regulaminu strony oraz politykę prywatności” umieszczonej w aplikacji Rekomenduj.to oznacza, że Użytkownik zapoznał się i akceptuje postanowienia Regulaminu i Polityki Prywatności oraz zobowiązuje się do przestrzegania Regulaminu. Brak akceptacji powyższej klauzuli uniemożliwia założenie Konta oraz korzystanie z aplikacji Rekomenduj.to.</li>
          <li>Formularz wypełniony nieprawidłowo lub niekompletnie nie podlega rejestracji.</li>
          <li>Prawidłowe wypełnienie i przesłanie formularza rejestracyjnego oraz innych czynności związanych z założeniem Konta, po dokonaniu rejestracji Konta – zgodnie z warunkami niniejszego Regulaminu - w systemie informatycznym Buzz Media jest równoznaczne z zawarciem umowy o zapewnienie dostępu do zawartości aplikacji Rekomenduj.to i świadczeń objętych niniejszym Regulaminem.</li>
          <li>W terminie 10 dni od zawarcia umowy, o której mowa w pkt 8, Użytkownik może od niej odstąpić bez podania przyczyn składając stosowne oświadczenie drogą elektroniczną lub na piśmie, przy czym do zachowania terminu wystarczy wysłanie pisma przed jego upływem. Użytkownik wyraża zgodę na rozpoczęcie świadczenia usług, w szczególności poprzez przystąpienie przez Użytkownika do Kampanii, przed upływem 10 dni od daty zawarcia umowy; przyjmuje nadto do wiadomości, że w takim przypadku prawo do odstąpienia od umowy nie przysługuje.</li>
          ...
          <li>Zakazane jest dostarczanie przez i do systemu teleinformatycznego Buzz Media przez Użytkownika treści o charakterze bezprawnym, w szczególności:
            <ol><li>powodujących zachwianie pracy lub przeciążenie systemów teleinformatycznych Buzz Media lub innych podmiotów biorącycezpośredni lub pośredni udział w świadczeniu usług drogą elektroniczną</li>
              <li>naruszających dobra osób trzecich, ogólnie przyjęte normy społeczne lub niezgodnych z powszechnie obowiązującymi przepisami prawa.</li></ol>
            </li>
            <li>Użytkownik zobowiązany jest podawać w formularzu rejestracyjnym oraz we wszystkich ankietach wypełnianych w związku z uczestnictwem w aplikacji Rekomenduj.to prawdziwe i rzetelne dane. Wszystkie formularze i ankiety powinny być wypełniane w sposób kompletny i zrozumiały. Podanie nieprawdziwych, niekompletnych lub nierzetelnych danych może uniemożliwić kontakt z Użytkownikiem lub spowodować niezakwalifikowanie Użytkownika do Kampanii. </li>
            <li>Użytkownik nie może udostępniać swojego Konta innym osobom, ani korzystać z Kont innych Użytkowników.</li>
            <li>Korzystanie przez Użytkownika z aplikacji Rekomenduj.to oraz udział w poszczególnych Kampaniach nie mogą odbywać się w celach komercyjnych. Użytkownik nie może sprzedawać otrzymanych do testowania produktów lub usług ani próbek produktów ani w jakikolwiek inny sposób odpłatnie przekazywać osobom trzecim.</li>
          </ol>


          <h2>III. Zasady udziału w Kampaniach</h2>
          <ol>
          <li>Udział w Kampanii może wziąć tylko Użytkownik aplikacji Rekomenduj.to. Udział Użytkownika w Kampaniach jest bezpłatny.</li>
            ...
            <li>Użytkownik może z własnej inicjatywy zgłosić się do udziału w Kampanii, o której informacje będą dostępne w aplikacji Rekomenduj.to lub też Buzz Media może wysłać zaproszenie do udziału w Kampanii do wybranych Użytkowników.</li>
            <li>Przed zakwalifikowaniem Użytkownika do Kampanii Buzz Media uprawnione jest do żądania od Użytkownika wypełnienia i wysłania ankiety rekrutacyjnej i ankiet profilowych umożliwiających Buzz Media dokonanie oceny czy Użytkownik pasuje do profilu ambasadora danej Kampanii.</li>
            <li>Ankiety profilowe mogą zawierać dane wrażliwe, o których mowa w art. 27 ustawy z dnia 29 sierpnia 1997 r. o ochronie danych osobowych, w szczególności takie jak dane ujawniające pochodzenie etniczne, dane o stanie zdrowia, nałogach lub życiu seksualnym. Ankiety profilowe będą dostępne dla Użytkownika po otrzymaniu przez Buzz Media podpisanej zgody na przetwarzanie danych Użytkownika obejmujących dane wrażliwe. Użytkownik powinien wydrukować treść zgody udostępnioną przez Buzz Media w aplikacji Rekomenduj.to, opatrzyć własnoręcznym podpisem, a następnie wysłać w formie pisemnej na adres Buzz Media. </li>
            ...
            <li>Ambasador Kampanii, którego Konto w aplikacji Rekomenduj.to zostało zablokowane lub usunięte z przyczyn wskazanych w punkcie IX ust. 2, zostaje wyłączony z dalszego udziału w Kampanii.</li>
          </ol>


          <h2>IV. Prawa autorskie</h2>
          <ol>
          <li>Użytkownik udziela Buzz Media nieodpłatnej, wyłącznej i bezterminowej licencji na korzystanie z utworów jego autorstwa powstałych w trakcie i w związku z korzystaniem z aplikacji Rekomenduj.to lub utworów jego autorstwa albo autorstwa osób trzecich, udostępnionych przez Użytkownika Buzz Media w ramach korzystania z aplikacji Rekomenduj.to, na następujących polach eksploatacji:
            <ol>
              <li>utrwalania jakąkolwiek techniką na wszelkich nośnikach, w tym techniką drukarską, reprograficzną, zapisu magncznego oraz techniką cyfrową;m. in. na dysku komputerowym, DVD, na taśmie magnetycznej, na kliszy fotograficznej, na CD, VCD, CD ROM; bez ograniczeń co do ilości i formatu oraz niezależnie od systemu i standardu</li>
          ...
          <li>Użytkownik wyraża nadto zgodę na korzystanie ze swojego wizerunku utrwalonego na fotografiach udostępnionych Buzz Media w ramach korzystania z aplikacji Rekomenduj.to, na polach eksploatacji wymienionych w ustępie powyższym (dalej o fotografiach oraz utworach, o których mowa w ust. 1: Utwory).</li>
          ...
          <li>Buzz Media jest uprawnione do udzielania dalszych zgód i licencji (sublicencji) osobom trzecim w zakresie określonym w ust. ust. 1-5.</li>
          </ol>

          <h2>V. Wymagania techniczne, zagrożenia związane z korzystaniem z sieci Internet</h2>
          <ol>
          <li>Minimalne wymagania techniczne umożliwiające prawidłowe korzystanie z aplikacji Rekomenduj.to obejmują:
              <ol>
            ...
            <li>Korzystanie przez Użytkownika z aplikacji Rekomenduj.to nie wiąże się dla użytkownika ze szczególnymi zagrożeniami związanymi z korzystaniem z usług świadczonych drogą elektroniczną, poza tymi, które powszechnie występują przy korzystaniu z publicznej sieci teleinformatycznej.</li>
          </ol>

          <h2>VI. Odpowiedzialność Buzz Media</h2>
          <ol>
            <li>Buzz Media nie ponosi odpowiedzialności w szczególności za:
              <li>jakiekolwiek szkody wyrządzone osobom trzecim, powstałe w wyniku korzystania przez Użytkownika z dostępu do usłu sposób sprzeczny z Regulaminem lub obowiązującymi przepisami prawa</li>
          ...
          <h2>VII. Przetwarzanie danych osobowych</h2>
          <ol>
            ...
            <li>Dane osobowe Użytkownika w zakresie podanym w formularzu zgłoszeniowym lub w ankietach będą zbierane i przetwarzane w celach związanych z korzystaniem przez Użytkownika aplikacji Rekomenduj.to oraz z udziałem w Kampaniach, w tym w szczególności z procesem doboru Ambasadorów Kampanii, zgodnie z ustawą z dnia 18 lipca 2002 r. o świadczeniu usług drogą elektroniczną (Dz. U. z 2002 r., nr 144, poz. 1204) oraz ustawą z dnia 29 sierpnia 1997 r. o ochronie danych osobowych (Dz. U. z 2002 r., nr 101, poz. 962).</li>
            <li>Dane osobowe Użytkownik podaje dobrowolnie, aczkolwiek podanie danych jest konieczne do korzystania z aplikacji Rekomenduj.to oraz do udziału w Kampaniach. Użytkownikowi przysługuje prawo do wglądu do swoich danych osobowych, prawo ich zmiany oraz żądania zaprzestania przetwarzania zgodnie z ustawą z dnia 29 sierpnia 1997 r. o ochronie danych osobowych (Dz. U. z 2002 r., nr 101, poz. 962).</li>
          ...
          <h2>VIII. Tryb postępowania reklamacyjnego</h2>
          <ol>
          <li>Użytkownik ma prawo składać reklamacje w sprawach dotyczących dostępu do aplikacji Rekomenduj.to. W szczególności reklamacje mogą być składane z tytułu braku lub nienależytego dostępu do usług.</li>
          ...
          <h2>IX. Rezygnacja/zakończenie korzystania z aplikacji Rekomenduj.to</h2>
          <ol>
          <li>Użytkownik może w każdym czasie zrezygnować z dostępu do aplikacji Rekomenduj.to i usunąć swoje Konto. W tym celu powinien wysłać oświadczenie w tym zakresie na adres e-mail: rezygnuje@rekomenduj.to.</li>
            <li>Buzz Media może zablokować lub usunąć Konto Użytkownika oraz dostęp do aplikacji Rekomenduj.to, jeżeli:
            <ol>
              <li>Użytkownik narusza postanowienia niniejszego Regulaminu</li>
              <li>Użytkownik dopuszcza się działań mogących utrudniać działanie aplikacji Rekomenduj.to</li>
