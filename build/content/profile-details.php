  ...
  <div class="focus--social-reach">
    <div class="roll-out roll-out__container">
      <a href="" class="roll-out__trigger social-reach__add" id="triggerAddSocial">
        <span class="roll-out__value"><?php
          $arraySocialReach = array(
            'sr-facebook',
            'sr-facebook-square',
            'sr-rss',
            'sr-twitter',
          ...
          if( isset($hasSocialReach) && ($hasSocialReach!=null) ) {
            foreach (array_rand($arraySocialReach, 3) as $srChannel) {
              echo '<span class="social-reach__icon '.$arraySocialReach[$srChannel].'"></span>';
            }
          }
          ?></span>
  ...
  <div class="roll-out__content">
    ...
    <div class="input input--select input--show-label">
      <select name="blog-category" id="blog-category" required>
        ...
        <option value="1">Fury, karki i wiertarki</option>
      </select>
    ...
    <div class="input input--number">
      <input tabindex name="number" id="number" type="number" step="100" min="0" max="" pattern="[0-9]" required spellcheck="false" placeholder="Podaj swoją odpowiedź">
      <label for="text"
...
<div class="layout__group">
  ...
  <section class="layout--card-3 roll-out roll-out__container">
    ...
    <div class="roll-out__content">
      ...
      <div class="input">
        <input tabindex
        name="user-surname" id="user-surname" type="text"
      ...
      <div class="input">
        <textarea tabindex name="email" id="user-bio" spellcheck="true" placeholder="Ta historia jest o Tobie..."></textarea>
        <label for="user-bio"
  ...
  <section class="layout--card-3 roll-out roll-out__container">
    ...
    <section class="layout--card-3 roll-out roll-out__container">
      <a href="" class="roll-out__trigger social-reach__add">
        <span class="roll-out__icon" data-icon="i"></span><span class="roll-out__name">Dane demograficzne</span><span class="roll-out__status" data-icon="e"></span>
      </a>
      <div class="roll-out__content">
        <div class="input input--select input--show-label">
