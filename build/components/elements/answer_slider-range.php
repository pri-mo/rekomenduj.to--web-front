...
<div class="layout--card-1 answer--slider">
  ...
  <div class="slider slider--snapping slider--range" data-s-min="<?php echo $dataMin ?>" data-s-max="<?php echo $dataMax ?>" data-s-default="<?php echo $dataDefault ?>" data-s-step="<?php echo $dataStep ?>" <?php echo $dataAffix ?>>
  </div>
</div>